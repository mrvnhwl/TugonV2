                  ...
                  <div className={cn(
                    ...
                    {shouldUseMathMode(index) ? (
                      <div className="flex-1 flex items-stretch gap-2">
                        ...
                        <motion.div
                          animate={validationTriggers.get(index) && !lineValidationStates.get(index)?.isCorrect ? {
                            x: [-2, 2, -2, 2, 0],
                        ...
                        {virtualKeyboardEnabled && line.trim() && (
                          <button
                            ...
                            className={cn(
                              "flex-shrink-0 self-center px-3 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all duration-200",
                              "flex items-center justify-center gap-1",
                              "min-w-[44px] w-[60px] sm:w-auto", // 📱 Fixed width on mobile for consistent positioning
                              checkCooldownStatus()
                                ? "bg-gray-400 text-gray-200 cursor-not-allowed opacity-60 border-gray-500"
                                : "bg-blue-500 hover:bg-blue-600 text-white shadow-md hover:shadow-lg border-blue-700",
                              "border-b-4"
                            )}
