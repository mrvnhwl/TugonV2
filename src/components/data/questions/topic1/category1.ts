...
export const Topic1_Category1: Question =  { 
        ...
        given_question: [
          ...
          { question_id: 2, category_text:"g(x) = x² + 2x + 1", question_text: "Find g(4)", question_type: "step-by-step", guide_text: "Replace x with 4." }, 
          { question_id: 3, category_text:"m(x) = 2x³ - x + 6", question_text: "Find m(2)", question_type: "step-by-step", guide_text: "Plug in -2 for x." }, //step by step
