                              ...
                              {!isBuiltin && t.status && (
                                <span
                                  className={cn(
                                    ...
                                    t.status === "ready" ? "bg-green-100 text-green-700 border-green-200" :
                                    t.status === "error" ? "bg-red-100 text-red-700 border-red-200" :
                                    "bg-yellow-100 text-yellow-700 border-yellow-200 animate-pulse"
                                  )}
                                  style={{ border: "1px solid" }}
                                  title={t.status_message || `AI Status: ${t.status}`}
                                >
